...
describe('Test Performance', function(){
  ...
  function testSize(size, fn) {
    ...
    it('large tree speed 0', function() {
        this.timeout(50000);

        for(var size = 10; size > 0; --size) {
    ...
    it('large tree speed 0.5', function() {
        this.timeout(50000);

        for(var size = 50000; size > 2; size = Math.ceil(size/1.5)) {
    ...
    if(process.env.PERF) {
        ...
        it('large tree speed 1', function () {
            this.timeout(50000);
        ...
        it('large tree speed 2', function () {
            this.timeout(50000);
